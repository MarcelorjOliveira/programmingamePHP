...
class ResumoProject {
    ...
    public function geraResumo() {
        $modelo = \imagecreatefromjpeg('images/perfil/project/resumo/modelo.jpg');
        \imagejpeg($modelo, 'images/perfil/project/resumo/modeloCopia.jpg');

        $resumo = \imagecreatefromjpeg('images/perfil/project/resumo/modeloCopia.jpg');
        ...
        \imagejpeg($resumo, 'images/perfil/project/resumo/' . $this->getProject() . '.jpg');
    }
