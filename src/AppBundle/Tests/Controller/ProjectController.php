...
class ProjectController extends Controller {
     ...
     * @Route("/index/pin/criar", name="criarProject")
     */
    public function criarAction(Request $request) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('pinresumocriar', array('pin' => $project->getId()));
        }


        return $this->render('hold/pin/criar.html.twig', array(
    ...
    /**
     * @Security("has_role('ROLE_EXPOSITOR')")
     * @Route("/index/pin/exibir/{id}", name="pinindex")
     */
...
//Get the first $amount users starting from a random point
        ...
        return $this->render('hold/pin/index.html.twig', array('objetoUsuario' => $objetoUsuario, 'objetoProject' => $objetoProject,
    ...
    /**
     * @Security("has_role('ROLE_EXPOSITOR')")
     * @Route("/index/pin/{id}/fotos", name="fotosProject")
     */
...
//Get the first $amount users starting from a random point
        ...
        return $this->render('hold/pin/fotos/index.html.twig', array('objetoUsuario' => $objetoUsuario, 'objetoProject' => $objetoProject, 'galleries' => $galleries,
            'perfil' => $objetoProject->getFotoPerfil(), 'capa' => $resumo->getCapa(), 'links' => $links, 'propaganda' => $propaganda, 'urlPropagandaImage' => $urlPropagandaImage));
    }

    /**
     * @Security("has_role('ROLE_EXPOSITOR')")
     * @Route("/index/pin/{id}/fotos/criar", name="criarFotosProject")
     */
    ...
    /**
     * @Route("/index/pin/fotos/criar/ajax", name="adicionarFotoAjax")
     */
